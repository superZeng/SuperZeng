...
namespace Obi
{
	...
	public abstract class Constraint{
		...
		/**
		 * Distributes position delta information to the particles. Optionally it can force immediate application.
		 */
		public abstract void DistributePositionDeltas(List<ObiClothParticle> particles, bool applyImmediately, float SORFactor, float dt);
		
		public virtual List<int> GetParticlesInvolved(){return null;}
