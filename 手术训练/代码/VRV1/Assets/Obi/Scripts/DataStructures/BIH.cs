...
public class BIH{
	...
	public class SurfaceInfo{
		...
		public float unsignedDistance{
			get{return Mathf.Sqrt(distanceSqr);}
		}

		public Vector3 signedVectorToSurface{
			get{return vectorToSurface * sign;}
		}
	...
	private SurfaceInfo DistanceToTriangles(Vector3 point,List<Triangle> triangles){
		...
		return new SurfaceInfo(minDistanceSqr,sign,normal,vectorToSurface);
